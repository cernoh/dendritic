...
| `herdr-web` | Mobile web UI for `herdr` ([eyalev/herdr-web](https://github.com/eyalev/herdr-web)): the bridge runs as a systemd user service on loopback, with `node-pty` compiled so panes reflow to the phone width |
