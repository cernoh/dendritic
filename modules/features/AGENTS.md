...
- **Feature table (current):** `act`, `agent-browser`, `brave`, `catppuccin`, `clipboard`, `computer-use`, `davinci`, `docker` (+ `mcp-containers.nix`), `dojjo`, `fish`, `gaming-tools`, `ghostty`, `lazygit`, `leetcode`, `mango`, `niri`, `nixpc-desktop`, `noctalia`, `noctalia-greeter`, `nushell`, `nvf`, `omp`, `opencode`, `posy-cursors`, `programming`, `steam`, `stremio-kai`, `usb-automount`, `wayland-base`, `widevine`.
