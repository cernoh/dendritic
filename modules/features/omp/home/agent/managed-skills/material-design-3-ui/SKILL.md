...
description: >
  Design, redesign, review, or implement user interfaces using Google Material Design 3 (M3),
  Material You, and optional Material 3 Expressive principles. Use for UI/UX screens, app flows,
  design systems, component selection, theming, responsive/adaptive layouts, accessibility audits,
  Figma-ready specifications, or developer handoff where Material Design 3 is required.
---
...
| Need                                                    | Read                                  |
|---------------------------------------------------------|---------------------------------------|
| Color roles, surfaces, dark theme, dynamic color        | `skill://material-design-3-ui/references/color-system.md`          |
| Type hierarchy, scaling, expressive typography          | `skill://material-design-3-ui/references/typography.md`            |
| Shape, cards, containment, elevation                    | `skill://material-design-3-ui/references/shape-and-elevation.md`   |
| Spacing, alignment, readable widths, safe areas         | `skill://material-design-3-ui/references/spacing-and-layout.md`    |
| Buttons, FAB, cards, chips, selection, inputs, feedback | `skill://material-design-3-ui/references/component-selection.md`   |
| Navigation bar/rail/drawer, tabs, app bars              | `skill://material-design-3-ui/references/navigation.md`            |
| Forms, validation, settings, text input                 | `skill://material-design-3-ui/references/forms-and-input.md`       |
| Snackbar, dialog, sheet, loading, empty/error states    | `skill://material-design-3-ui/references/feedback-and-overlays.md` |
| Responsive, tablet, foldable, desktop, multi-pane       | `skill://material-design-3-ui/references/adaptive-design.md`       |
| Accessibility audit or any final UI review              | `skill://material-design-3-ui/references/accessibility.md`         |
| Transitions, feedback animation, shape morphing         | `skill://material-design-3-ui/references/motion.md`                |
| Material 3 Expressive                                   | `skill://material-design-3-ui/references/m3-expressive.md`         |
| Final audit / suspicious “Material-looking” UI          | `skill://material-design-3-ui/references/anti-patterns.md`         |
...
Read `skill://material-design-3-ui/references/adaptive-design.md` and `skill://material-design-3-ui/references/navigation.md` when multiple window sizes or navigation forms matter.
...
Read `skill://material-design-3-ui/references/component-selection.md` plus specialized navigation/form/feedback references as needed.
...
Read `skill://material-design-3-ui/references/accessibility.md`.

Accessibility is a release requirement. Do not defer it to visual polish.

### 8. Add motion

Read `skill://material-design-3-ui/references/motion.md` only when motion is part of the task.
...
Read `skill://material-design-3-ui/references/m3-expressive.md`.
...
Read `skill://material-design-3-ui/references/anti-patterns.md` and run the self-audit below.
