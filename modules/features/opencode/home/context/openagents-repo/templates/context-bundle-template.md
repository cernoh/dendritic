...
**Core Standards**:
- `/home/davinceyr/.config/opencode/context/core/standards/code.md` → Modular, functional code patterns
- `/home/davinceyr/.config/opencode/context/core/standards/tests.md` → Testing requirements and TDD
- `/home/davinceyr/.config/opencode/context/core/standards/docs.md` → Documentation standards
- (example: `/home/davinceyr/.config/opencode/context/core/standards/patterns.md`) → Error handling, security patterns

**Core Workflows**:
- (example: `/home/davinceyr/.config/opencode/context/core/workflows/delegation.md`) → Delegation process
- (example: `/home/davinceyr/.config/opencode/context/core/workflows/task-breakdown.md`) → Task breakdown methodology
- (example: `/home/davinceyr/.config/opencode/context/core/workflows/review.md`) → Code review guidelines
