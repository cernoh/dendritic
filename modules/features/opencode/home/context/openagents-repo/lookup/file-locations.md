...
| **Context files** | `/home/davinceyr/.config/opencode/context/` |
...
| **New context** | `/home/davinceyr/.config/opencode/context/{category}/{name}.md` |
...
```
/home/davinceyr/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/home/davinceyr/.config/opencode/context/core/standards/code-quality.md`
- `/home/davinceyr/.config/opencode/context/ui/web/react-patterns.md`
- `/home/davinceyr/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /home/davinceyr/.config/opencode/context/{category}/

# All context
find /home/davinceyr/.config/opencode/context -name "*.md"
```
