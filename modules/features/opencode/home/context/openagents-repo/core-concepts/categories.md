...
/home/davinceyr/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /home/davinceyr/.config/opencode/context/{category}
...
```bash
cat > /home/davinceyr/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/home/davinceyr/.config/opencode/context/{category}/
...
Loads: `/home/davinceyr/.config/opencode/context/ui/web/react-patterns.md`
