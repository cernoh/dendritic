...
```bash
npx ts-node /home/davinceyr/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/home/davinceyr/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
