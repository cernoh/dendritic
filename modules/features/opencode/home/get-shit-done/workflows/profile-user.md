...
Key references:
- @/home/da/.config/opencode/get-shit-done/references/ui-brand.md (display patterns)
- @/home/da/.config/opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/da/.config/opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/da/.config/opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/da/.config/opencode/get-shit-done/USER-PROFILE.md" "/home/da/.config/opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/da/.config/opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/da/.config/opencode/get-shit-done/references/user-profiling.md`
...
Reference: @/home/da/.config/opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/da/.config/opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /home/da/.config/opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/da/.config/opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/da/.config/opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/da/.config/opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/home/da/.config/opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /home/da/.config/opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/da/.config/opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /home/da/.config/opencode/AGENTS.md
```
