...
- ✅ Flexible context discovery (.oac config, .claude/context, context, /home/davinceyr/.config/opencode/context)
...
**The OAC solution:** Store team patterns in `/home/davinceyr/.config/opencode/context/project/`. Commit to repo. Everyone uses same standards.
...
# Commit to repo
git add /home/davinceyr/.config/opencode/context/
...
Store patterns in `/home/davinceyr/.config/opencode/context/project/`. Commit to repo. Entire team uses same standards. New developers inherit patterns automatically.
...
```
1. Check local: /home/davinceyr/.config/opencode/context/core/navigation.md
...
- **Project intelligence is always local** — your tech stack, patterns, and naming conventions live in `/home/davinceyr/.config/opencode/context/project-intelligence/` and are never loaded from global
...
|-------|----------------|--------------------------|
| Local install (`bash install.sh developer`) | `/home/davinceyr/.config/opencode/context/core/` | `/home/davinceyr/.config/opencode/context/project-intelligence/` |
| Global install + `/add-context` | `~/.config/opencode/context/core/` | `/home/davinceyr/.config/opencode/context/project-intelligence/` |
| Both local and global | `/home/davinceyr/.config/opencode/context/core/` (local wins) | `/home/davinceyr/.config/opencode/context/project-intelligence/` |
...
A: Commit `/home/davinceyr/.config/opencode/context/project/` to your repo. Team members automatically use same patterns.
