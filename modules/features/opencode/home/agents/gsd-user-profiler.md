...
<reference>
@/home/da/.config/opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/da/.config/opencode/get-shit-done/references/user-profiling.md` to load:
