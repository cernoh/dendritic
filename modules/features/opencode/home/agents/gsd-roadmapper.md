...
Reference full template: `/home/da/.config/opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/da/.config/opencode/get-shit-done/templates/state.md`.
